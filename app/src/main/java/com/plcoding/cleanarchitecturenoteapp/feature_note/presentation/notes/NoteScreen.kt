...
import com.plcoding.cleanarchitecturenoteapp.feature_note.presentation.notes.components.NoteEvents
import com.plcoding.cleanarchitecturenoteapp.feature_note.presentation.notes.components.NoteItem
import com.plcoding.cleanarchitecturenoteapp.feature_note.presentation.notes.components.NoteViewModel
            ...
            LazyColumn(modifier = Modifier.fillMaxSize()){
                items(state.notes){note->
                    NoteItem(
                        ...
                        onDeleteClick = {
                            viewModel.onEvent(NoteEvents.DeleteNotes(note))
                             scope.launch {
